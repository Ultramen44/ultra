...
clear;clear;clear
  ...
  # // Banner
echo -e "${BLUE}----------------------------------------------------------${NC}"
echo -e " WELCOME TO ULTRA STORE SCRIPT ${BLUE}(${NC}${green}Stable Edition${NC}${BLUE})${NC}"
echo -e " PROSES PENGECEKAN IP ADDRESS ANDA !!"
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green} ULTRA STORE ® ${NC}${BLUE}(${NC}${green}V 0.0${NC}${BLUE})${NC}"
echo -e " ›TEAM : ULTRA STORE ${BLUE}(${NC} 2024 ${BLUE})${NC}"
echo -e "${BLUE}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
<code>────────────────────</code>
<b> ULTRA STORE VVIP SCRIPT  </b>
<code>────────────────────</code>
<i>Notifications From UltraStore AutoSc</i>
