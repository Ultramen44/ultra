...
clear;clear;clear
  ...
  # // Banner
echo -e "${BLUE}----------------------------------------------------------${NC}"
echo -e " WELCOME TO ULTRAMEN STORE SCRIPT ${BLUE}(${NC}${green}Stable Edition${NC}${BLUE})${NC}"
echo -e " PROSES PENGECEKAN IP ADDRESS ANDA !!"
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green} ULTRAMEN STORE ® ${NC}${BLUE}(${NC}${green}V 0.0${NC}${BLUE})${NC}"
echo -e " ›TEAM : ULTRAMEN STORE ${BLUE}(${NC} 2024 ${BLUE})${NC}"
echo -e "${BLUE}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Ultramen44/ultra/main/"
...
clear
izinsc="https://raw.githubusercontent.com/Ultramen44/permision/main/ultra"
# USERNAME
rm -f /usr/bin/user
...
<code>────────────────────</code>
<b> ULTRAMEN STORE VVIP SCRIPT  </b>
<code>────────────────────</code>
<i>Notifications From UltramenStore AutoSc</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"t.me/Ultramenstor"}]]}' 
...
wget -q https://raw.githubusercontent.com/Ultramen44/ultra/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
