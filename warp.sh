...
data_ip="https://raw.githubusercontent.com/Ultramen44/permision/main/ultra"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "\033[42m          ULTRA STORE AUTOSCRIPT          \033[0m"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    echo -e ""
    ...
    echo -e "      ${GREEN}Telegram${NC} t.me/Ultramenstor"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit 0
  fi
}
