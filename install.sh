...
date_list=$(date +"%Y-%m-%d" -d "$data_server")
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME TO WONG NDEZO VPN PREMIUM ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Ultramen44/ultra/refs/heads/main/"
...
<code>─────────────────────────────</code>
<b> ILHAM GANTENG VPN SCRIPT  </b>
<code>─────────────────────────────</code>
<i>Automatic Notifications From Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"t.me/Ultramenstore"}]]}' 
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ SCRIPT BY WONG NDEZO OFFICIAL ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
echo "Semuanya Berjalan Ok...Terimakasih Telah menggunakan Script wong ndezo official!!"
sleep 1
