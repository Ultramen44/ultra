...
date_list=$(date +"%Y-%m-%d" -d "$data_server")
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME TO WONG NDEZO STORE ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
echo -e " PROSES PENGECEKAN IP ADDRESS ANDA !!"
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green}WONG NDEZO STORE® ${NC}${YELLOW}(${NC}${green}V 3.5${NC}${YELLOW})${NC}"
echo -e " ›TEAM 🅥🅝: WONG NDEZO STORE ${YELLOW}(${NC} 2025 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Ultramen44/ultra/heads/main/"
...
clear
izinsc="https://raw.githubusercontent.com/Ultramen44/permision/refs/heads/main/ultra"
# USERNAME
rm -f /usr/bin/user
...
Exp-Sc=$(curl $izinsc | grep $MYIP | awk '{print $4}')
User=$(cat /usr/bin/user)
    TEXT="
<code>────────────────────</code>
<b>⚡𝗡𝗢𝗧𝗜𝗙 𝗜𝗡𝗦𝗧𝗔𝗟𝗟 𝗦𝗖𝗥𝗜𝗣𝗧⚡</b>
<code>────────────────────</code>
<code>USER NAME     :</code><code>$User</code>
<code>ISP           :</code><code>$ISP</code>
<code>CITY          :</code><code>$CITY</code>
<code>IP            :</code><code>$IP</code>
<code>DATE          :</code><code>$DATE</code>
<code>Time          :</code><code>$TIMEZONE</code>
<code>Expired       :</code><code>$Exp-Sc</code>
<code>─────────────────────────────</code>
<b> WONG NDEZO STORE SCRIPT  </b>
<code>─────────────────────────────</code>
<i>Automatic Notifications From Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"t.me/SinggahPremium"}]]}' 
...
bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh)" @ install -u www-data --version $latest_version
    ...
    sudo curl -fsSL https://raw.githubusercontent.com/Ultramen44/ultra/refs/heads/main/config/nginx.conf -o /etc/nginx/nginx.conf
...
wget -q https://raw.githubusercontent.com/Ultramen44/ultra/refs/heads/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
wget -q -O /etc/default/dropbear https://raw.githubusercontent.com/Ultramen44/ultra/refs/heads/main/config/dropbear.conf
...
wget -q https://raw.githubusercontent.com/Ultramen44/ultra/refs/heads/main/udp-custom/udp-custom.sh
...
#OpenVPN
wget https://raw.githubusercontent.com/Ultramen44/ultra/refs/heads/main/config/openvpn  chmod +x openvpn && ./openvpn
...
# Ganti Banner
wget -O /etc/kyt.txt https://raw.githubusercontent.com/Ultramen44/ultra/refs/heads/main/files/issue.net
...
function install_zivpn() {
    ...
    if [ ! -f "/etc/zivpn/user-db.json" ]; then
        ...
        chmod 644 /etc/zivpn/user-db.json
    fi
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ SCRIPT BY WONG NDEZO VPN ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
echo "Semuanya Berjalan Ok...Terimakasih Telah menggunakan Script Singgah!!"
sleep 1
